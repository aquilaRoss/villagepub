...
- Linux CI installs only confirmed-needed packages: `libgl1-mesa-dev libx11-dev libasound2-dev` — add more only if the pipeline fails with a specific missing dependency
